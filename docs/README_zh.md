...
- **核心定位**: 最棒的浏览器网页总结工具！极速。极简。没有乱七八糟的AI杂烩功能。相信我！
...
- 在浏览器中最方便快捷的网页内容总结工具
- 浏览器内置 AI 工具的纯净、轻量级替代品
- 不会实现**各种接入 + agent loop**功能，保持纯粹简单，*不再对标 sider.ai、monica.ai 等复杂产品*

*启发自: [chatGPTBox](https://github.com/josStorer/chatGPTBox)*
